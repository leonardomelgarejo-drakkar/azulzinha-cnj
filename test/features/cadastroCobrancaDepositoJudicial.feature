Feature: Cadastro Cobranca Deposito Judicial
  ...
  @deposito-judicial @completo @e2e-test @smoke-test
  ...
  @deposito-judicial @codigo-processo-vazio
  ...
  @deposito-judicial @codigo-processo-curto
  ...
  @deposito-judicial @codigo-processo-longo
...
@deposito-judicial @nome-autor-vazio
...
@deposito-judicial @nome-autor-curto
  ...
  @deposito-judicial @nome-autor-longo
  ...
  @deposito-judicial @cpf-autor-invalido
  ...
  @deposito-judicial @cpf-autor-vazio
  ...
  @deposito-judicial @documento-autor-divergente
  ...
  @deposito-judicial @nome-reu-vazio
  ...
  @deposito-judicial @nome-reu-curto
  ...
  @deposito-judicial @nome-reu-longo
  ...
  @deposito-judicial @cpf-reu-invalido
  ...
  @deposito-judicial @documento-reu-divergente
  ...
  @deposito-judicial @nome-depositante-curto
  ...
  @deposito-judicial @nome-depositante-longo
  ...
  @deposito-judicial @cnpj-depositante-vazio
  ...
  @deposito-judicial @cnpj-depositate-invalido
  ...
  @deposito-judicial @documento-depositante-divergente
  ...
  @deposito-judicial @email-depositante-vazio
  ...
  @deposito-judicial @email-depositante-invalido
  ...
  @deposito-judicial @telefone-depositante-vazio
  ...
  @deposito-judicial @telefone-depositante-invalido
  ...
  @deposito-judicial @tentativa-cadastro-duplo
  ...
  @deposito-judicial @finalidade-deposito-vazia
  ...
  @deposito-judicial @observacao-deposito-vazia

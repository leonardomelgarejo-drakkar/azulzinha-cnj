Feature: Cadastro Cobranca Deposito Judicial
  ...
  @calculo-parcelamento @todas-parcelas @e2e-test @smoke-test
  ...
  Examples:
    ...
    | 2        | 1000.01       | 501,26       | 1.002,51   | 2,50        |
